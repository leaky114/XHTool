...
Partial Class FormOption
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbo添加.Items.AddRange(New Object() {"| (分隔符)", "Web", "材料", "成本", "成本中心", "供应商", "空格", "库存编号", "零件代号", "面积", "描述", "数量", "所属装配", "所属装配代号", "文件路径", "文件名", "项目序号", "质量", "总成本", "总数量", "总质量"})
        ...
        Me.cbo图号材质.Size = New System.Drawing.Size(85, 20)
        ...
        Me.cbo向下线型.Items.AddRange(New Object() {"实线", "虚线", "点长划线", "双点长划线", "三点长划线"})
        ...
        Me.cbo向上线型.Items.AddRange(New Object() {"实线", "虚线", "点长划线", "双点长划线", "三点长划线"})
    ...
    Friend WithEvents txt工艺文字高 As System.Windows.Forms.TextBox
    Friend WithEvents lbl工艺文字高 As System.Windows.Forms.Label
