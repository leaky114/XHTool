...
Partial Class FormSetReadOnly
    ...
    Private Sub InitializeComponent()
        ...
        'cms文件列表右键菜单
        '
        Me.cms文件列表右键菜单.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.列表全部只读tsmi, Me.列表全部可写tsmi, Me.列表读写tsmi, Me.列表打开tsmi})
        Me.cms文件列表右键菜单.Name = "cmsRemove"
        Me.cms文件列表右键菜单.Size = New System.Drawing.Size(174, 92)
        '
        '列表全部只读tsmi
        '
        Me.列表全部只读tsmi.Name = "列表全部只读tsmi"
        Me.列表全部只读tsmi.ShortcutKeys = CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.R), System.Windows.Forms.Keys)
        Me.列表全部只读tsmi.Size = New System.Drawing.Size(173, 22)
        ...
        Me.列表全部可写tsmi.ShortcutKeys = CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.W), System.Windows.Forms.Keys)
        Me.列表全部可写tsmi.Size = New System.Drawing.Size(173, 22)
        ...
        Me.列表读写tsmi.Size = New System.Drawing.Size(173, 22)
        ...
        Me.列表打开tsmi.Size = New System.Drawing.Size(173, 22)
        Me.列表打开tsmi.Text = "打开"
        ...
        Me.TreeV文件树.ImageIndex = 0
        Me.TreeV文件树.ImageList = Me.ImageList1
        Me.TreeV文件树.Location = New System.Drawing.Point(0, 0)
        Me.TreeV文件树.Name = "TreeV文件树"
        Me.TreeV文件树.SelectedImageIndex = 0
        ...
        'cms文件树右键菜单
        '
        Me.cms文件树右键菜单.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.树全部只读tsmi, Me.树全部可写tsmi, Me.树读写tsmi, Me.树打开tsmi, Me.树全部展开tsmi, Me.树全部收拢tsmi, Me.树清空tsmi})
        Me.cms文件树右键菜单.Name = "cmsRemove"
        Me.cms文件树右键菜单.Size = New System.Drawing.Size(174, 158)
        '
        '树全部只读tsmi
        '
        Me.树全部只读tsmi.Name = "树全部只读tsmi"
        Me.树全部只读tsmi.ShortcutKeys = CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.R), System.Windows.Forms.Keys)
        Me.树全部只读tsmi.Size = New System.Drawing.Size(173, 22)
        ...
        Me.树全部可写tsmi.ShortcutKeys = CType((System.Windows.Forms.Keys.Control Or System.Windows.Forms.Keys.W), System.Windows.Forms.Keys)
        Me.树全部可写tsmi.Size = New System.Drawing.Size(173, 22)
        ...
        Me.树读写tsmi.Size = New System.Drawing.Size(173, 22)
        Me.树读写tsmi.Text = "读-写"
        ...
        Me.树打开tsmi.Size = New System.Drawing.Size(173, 22)
        Me.树打开tsmi.Text = "打开"
        ...
        Me.树全部展开tsmi.Size = New System.Drawing.Size(173, 22)
        Me.树全部展开tsmi.Text = "全部展开"
        '
        '树全部收拢tsmi
        '
        Me.树全部收拢tsmi.Name = "树全部收拢tsmi"
        Me.树全部收拢tsmi.Size = New System.Drawing.Size(173, 22)
        Me.树全部收拢tsmi.Text = "全部收拢"
        '
        '树清空tsmi
        '
        Me.树清空tsmi.Name = "树清空tsmi"
        Me.树清空tsmi.Size = New System.Drawing.Size(173, 22)
        Me.树清空tsmi.Text = "清空"
        '
        'ImageList1
        '
        ...
        Me.ImageList1.Images.SetKeyName(3, "参考件16.ICO")
        '
        'Lvw文件列表
        '
