...
Partial Class FormMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.资源管理器ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.快速打开ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        Me.打开列表ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        Me.修改序号ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        Me.批量BOM命名ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        Me.设置颜色窗口ToolStripMenuItem = New System.Windows.Forms.ToolStripMenuItem()
        ...
        'MenuStrip1
        '
        Me.MenuStrip1.Items.AddRange(New System.Windows.Forms.ToolStripItem() {Me.文件ToolStripMenuItem, Me.部件ToolStripMenuItem, Me.零件ToolStripMenuItem, Me.工程图ToolStripMenuItem, Me.尺寸ToolStripMenuItem, Me.序号ToolStripMenuItem, Me.签字ToolStripMenuItem, Me.打印ToolStripMenuItem, Me.ERPToolStripMenuItem, Me.工具ToolStripMenuItem, Me.关于ToolStripMenuItem})
        Me.MenuStrip1.Location = New System.Drawing.Point(0, 0)
        Me.MenuStrip1.Name = "MenuStrip1"
        Me.MenuStrip1.Size = New System.Drawing.Size(621, 25)
        Me.MenuStrip1.TabIndex = 17
        Me.MenuStrip1.Text = "MenuStrip1"
        '
        '文件ToolStripMenuItem
        '
        Me.文件ToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.资源管理器ToolStripMenuItem, Me.快速打开ToolStripMenuItem, Me.打开列表ToolStripMenuItem, Me.保存列表ToolStripMenuItem, Me.ToolStripSeparator5, Me.保存关闭ToolStripMenuItem, Me.关闭ToolStripMenuItem, Me.打开文件所在文件夹ToolStripMenuItem, Me.保存关闭所有文件ToolStripMenuItem, Me.ToolStripSeparator1, Me.退出ToolStripMenuItem})
        ...
        '
        Me.资源管理器ToolStripMenuItem.Name = "资源管理器ToolStripMenuItem"
        Me.资源管理器ToolStripMenuItem.Size = New System.Drawing.Size(184, 22)
        Me.资源管理器ToolStripMenuItem.Text = "资源管理器..."
        '
        ...
        '
        Me.打开列表ToolStripMenuItem.Name = "打开列表ToolStripMenuItem"
        Me.打开列表ToolStripMenuItem.Size = New System.Drawing.Size(184, 22)
        Me.打开列表ToolStripMenuItem.Text = "打开列表"
        '
        '保存列表ToolStripMenuItem
        '
        Me.保存列表ToolStripMenuItem.Name = "保存列表ToolStripMenuItem"
        Me.保存列表ToolStripMenuItem.Size = New System.Drawing.Size(184, 22)
        ...
        '部件ToolStripMenuItem
        '
        Me.部件ToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.标准件可见性ToolStripMenuItem, Me.查找替换ToolStripMenuItem, Me.查找缺失部件ToolStripMenuItem, Me.打开父部件ToolStripMenuItem, Me.打开选择的组件ToolStripMenuItem, Me.打开指定工程图ToolStripMenuItem, Me.对齐原始坐标面ToolStripMenuItem, Me.检查钣金厚度ToolStripMenuItem, Me.检查是否有工程图ToolStripMenuItem, Me.距离对齐ToolStripMenuItem, Me.克隆组件ToolStripMenuItem, Me.另存为副本ToolStripMenuItem, Me.批量替换文件名ToolStripMenuItem, Me.全部可见ToolStripMenuItem, Me.生成图号ToolStripMenuItem, Me.设置虚拟件ToolStripMenuItem, Me.随机颜色ToolStripMenuItem, Me.替换为库文件ToolStripMenuItem, Me.提取iproperty更改文件名ToolStripMenuItem, Me.移动指定文件ToolStripMenuItem})
        ...
        '
        Me.随机颜色ToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.设置随机颜色ToolStripMenuItem, Me.清除颜色ToolStripMenuItem, Me.设置颜色窗口ToolStripMenuItem})
        ...
        Me.设置随机颜色ToolStripMenuItem.Size = New System.Drawing.Size(180, 22)
        Me.设置随机颜色ToolStripMenuItem.Text = "设置颜色"
        '
        '清除颜色ToolStripMenuItem
        '
        Me.清除颜色ToolStripMenuItem.Name = "清除颜色ToolStripMenuItem"
        Me.清除颜色ToolStripMenuItem.Size = New System.Drawing.Size(180, 22)
        ...
        Me.基础数量ToolStripMenuItem.Size = New System.Drawing.Size(148, 22)
        Me.基础数量ToolStripMenuItem.Text = "基础数量"
        '
        '复制材料ToolStripMenuItem
        '
        Me.复制材料ToolStripMenuItem.Name = "复制材料ToolStripMenuItem"
        Me.复制材料ToolStripMenuItem.Size = New System.Drawing.Size(148, 22)
        ...
        '
        Me.标记孔径ToolStripMenuItem.Name = "标记孔径ToolStripMenuItem"
        ...
        '
        Me.在浏览器中查找ToolStripMenuItem.Name = "在浏览器中查找ToolStripMenuItem"
        ...
        '序号ToolStripMenuItem
        '
        Me.序号ToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.检查序号完整性ToolStripMenuItem, Me.新建序号ToolStripMenuItem, Me.自动重建序号ToolStripMenuItem, Me.重写BOM序号ToolStripMenuItem, Me.修改序号ToolStripMenuItem})
        ...
        '
        Me.修改序号ToolStripMenuItem.Name = "修改序号ToolStripMenuItem"
        Me.修改序号ToolStripMenuItem.Size = New System.Drawing.Size(160, 22)
        Me.修改序号ToolStripMenuItem.Text = "修改序号"
        '
        '签字ToolStripMenuItem
        '
        ...
        '
        Me.ERPToolStripMenuItem.DropDownItems.AddRange(New System.Windows.Forms.ToolStripItem() {Me.查询ERP编码ToolStripMenuItem, Me.ERP反查ToolStripMenuItem, Me.ToolStripSeparator2, Me.导出BOM平面性ToolStripMenuItem, Me.导入ERPToolStripMenuItem, Me.导入ERP到BOMToolStripMenuItem, Me.批量BOM命名ToolStripMenuItem, Me.打开数据文件ToolStripMenuItem})
        ...
        Me.导出BOM平面性ToolStripMenuItem.Text = "导出平面BOM"
        '
        ...
        '
        '批量BOM命名ToolStripMenuItem
        '
        Me.批量BOM命名ToolStripMenuItem.Name = "批量BOM命名ToolStripMenuItem"
        Me.批量BOM命名ToolStripMenuItem.Size = New System.Drawing.Size(163, 22)
        Me.批量BOM命名ToolStripMenuItem.Text = "批量BOM命名"
        '
        ...
        '
        Me.格式转换ToolStripMenuItem.Name = "格式转换ToolStripMenuItem"
        Me.格式转换ToolStripMenuItem.Size = New System.Drawing.Size(165, 22)
        Me.格式转换ToolStripMenuItem.Text = "格式转换"
        '
        '还原旧图ToolStripMenuItem
        '
        Me.还原旧图ToolStripMenuItem.Name = "还原旧图ToolStripMenuItem"
        Me.还原旧图ToolStripMenuItem.Size = New System.Drawing.Size(165, 22)
        Me.还原旧图ToolStripMenuItem.Text = "还原旧图"
        '
        '清理旧版文件ToolStripMenuItem
        '
        Me.清理旧版文件ToolStripMenuItem.Name = "清理旧版文件ToolStripMenuItem"
        Me.清理旧版文件ToolStripMenuItem.Size = New System.Drawing.Size(165, 22)
        ...
        '
        Me.自定义iPropertyToolStripMenuItem.Name = "自定义iPropertyToolStripMenuItem"
        ...
        '
        '关于2ToolStripMenuItem
        '
        Me.关于2ToolStripMenuItem.Name = "关于2ToolStripMenuItem"
        Me.关于2ToolStripMenuItem.Size = New System.Drawing.Size(100, 22)
        Me.关于2ToolStripMenuItem.Text = "关于"
        '
        'Button1
        '
        ...
        Me.Button2.Text = "DockableWindow"
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(506, 31)
        ...
        '
        '设置颜色窗口ToolStripMenuItem
        '
        Me.设置颜色窗口ToolStripMenuItem.Name = "设置颜色窗口ToolStripMenuItem"
        Me.设置颜色窗口ToolStripMenuItem.Size = New System.Drawing.Size(180, 22)
        Me.设置颜色窗口ToolStripMenuItem.Text = "设置颜色窗口"
        '
        'FormMain
        '
        Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 12.0!)
        Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
        Me.ClientSize = New System.Drawing.Size(621, 118)
    ...
    Friend WithEvents 格式转换ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents 同步目录树ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents 打开列表ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents 断开链接ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents 保存列表ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    Friend WithEvents ToolStripSeparator5 As System.Windows.Forms.ToolStripSeparator
    Friend WithEvents 替换基础文件ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents 在浏览器中查找ToolStripMenuItem As System.Windows.Forms.ToolStripMenuItem
    ...
    Friend WithEvents 设置颜色窗口ToolStripMenuItem As ToolStripMenuItem
End Class
