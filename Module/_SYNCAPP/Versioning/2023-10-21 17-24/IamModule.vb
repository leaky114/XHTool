                    ...
                    If oBOMView.ViewType = BOMViewTypeEnum.kStructuredBOMViewType Then
                        ...
                        For i = 1 To intStepCount
                            ...
                            If oBOMRow.ReferencedFileDescriptor.ReferencedFileType = FileTypeEnum.kPartFileType Then
                                ...
                                CreateFlatSub(oInventorPartDocument, strBasicIdwFileFullName)
                            End If
999:
                        Next
                    End If
    ...
    Public Sub CreateFlatSub(ByVal oInventorDocument As Inventor.PartDocument, ByVal strBasicIdwFileFullName As String)
        On Error Resume Next

        Dim oBaseViewOptions As NameValueMap = ThisApplication.TransientObjects.CreateNameValueMap
        Dim oTG As TransientGeometry = ThisApplication.TransientGeometry
        Dim oPoint As Point2d = oTG.CreatePoint2d(10, 20)
        ...
        Dim oBaseView As DrawingView = oSheet.DrawingViews.AddBaseView(oInventorDocument, oPoint, 1,
        ...
        Dim strInventorDrawingFolder As String
        strInventorDrawingFolder = oFileNameInfo.Folder & "\钣金展开\"
